...
public sealed class Envelope
{
	...
	public static Envelope FromEncodedMessageBuffer(ref EncodedMessageBuffer buffer)
	{
		...
		var contentsWireValue = buffer.ReadBytes(countAndLength.MessageLength.Value).ToArray();
		var contents = MessageContentsCodec.Decode(messageType, contentsWireValue);
