...
{
	[Fact]
	public void Does_not_expose_the_raw_reason_code_set_or_value()
	{
		var publicPropertyNames = typeof(ReasonCode).GetProperties()
			.Select(property => property.Name);

		publicPropertyNames.Should().NotContain(["Set", "Value"]);
	}
