Feature: Envelopes
  ...
  Scenario: Rejecting a known unsupported Envelope with a Negative Acknowledgement
    Given encoded Envelope bytes "1A191902011A191912FCD164010100044649524544"
    And the affected destination is Brigade 26, Node 101, Port 26
    When the Envelope is decoded
    Then its Contents are preserved as Message Type 100 with bytes "0101000446495245"
