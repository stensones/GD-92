...
public sealed class EfLanMtaParameterStore : IParticipantParameterStore
{
	private const long InitializationLockKey = 5_277_279_571_069_133_815;
	private readonly LanMtaDbContext context;

	public EfLanMtaParameterStore(LanMtaDbContext context)
	{
					...
					async initializeCancellationToken =>
					{
							...
							initializeCancellationToken) is not null)
						{
							throw new DbUpdateConcurrencyException(
								"LAN MTA Parameter Store was initialized concurrently.");
						}
