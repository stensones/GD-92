...
public sealed class EfPrinterUaParameterStore : IParticipantParameterStore
{
	private const long InitializationLockKey = 4_712_304_988_155_029_477;
	private readonly PrinterUaDbContext context;

	public EfPrinterUaParameterStore(PrinterUaDbContext context)
	{
					...
					async initializeCancellationToken =>
					{
							...
							initializeCancellationToken) is not null)
						{
							throw new DbUpdateConcurrencyException(
								"Printer UA Parameter Store was initialized concurrently.");
						}
